...
import { clearProducts } from '../../redux/slices/cart';
import { RootState } from '../../redux/store';
import { getRandomString } from '../../utils/getRandomString';
import { mapCartProductsArr } from '../../utils/mapCartProductsArr';
    ...
    <>
      {
        ...
        <div className='cart'>
          ...
          <ul className='cart__items'>
            {
              mapCartProductsArr(mappedProducts).map((obj: IPizzaProductObj) => 
          ...
          <div className='cart__bottom'>
            <div className='cart__bottom-details'>
              <span> Всего пицц: <b>{products.length} шт.</b> </span>
            ...
            <div className='cart__bottom-buttons'>
              ...
              <button className='button pay-btn' onClick={onOrder}>
                Заказать
              </button>
            </div>
          </div>
      ...
      { isModal &&       
        <Modal additionalFunc={onClose}>
          <OrderForm additionalFunc={onClear} />
        </Modal>
      }
    </>
  )
